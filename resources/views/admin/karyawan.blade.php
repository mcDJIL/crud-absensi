            ...
            <div class="place-content-center h-auto mb-4">
                ...
                <div id="create-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            @if (session('success'))
                                <div class="flex items-center p-4 mx-5 mt-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800"
                                    role="alert">
                            ...
                            <form class="p-4 md:p-5" method="post" action="{{ route('karyawan.store') }}">
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <input type="number" name="umur" id="price"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea id="description" name="alamat" rows="4"
                                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Tulis alamat dari karyawan tersebut"></textarea>
                ...
                <div class="">
                    <button data-modal-target="create-modal" data-modal-toggle="create-modal" type="button"
                        ...
                        Karyawan</button>
                    <a href="{{ route('import') }}"
                        class="float-end sm:float-none focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Import</a>

                    <a href="{{ route('karyawan.export') }}"
                        class="float-none mb-4 sm:mb-0 sm:float-end text-gray-900 hover:text-gray-500 border border-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">
                            ...
                            <tr>
                                <th scope="col" class="px-6 py-3">
                                    <div class="flex items-center">
                                        ID
                                        <a href="{{ route('admin.karyawan', [ 'sort_field' => 'id', 'sort_direction' => ($sortField === 'id' && $sortDirection === 'asc') ? 'desc' : 'asc' ]) }}"><svg class="w-3 h-3 ms-1.5" aria-hidden="true"
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <div class="flex items-center">
                                        Nama
                                        <a href="{{ route('admin.karyawan', ['sort_field' => 'nama', 'sort_direction' => ($sortField === 'nama' && $sortDirection === 'asc') ? 'desc' : 'asc']) }}"><svg class="w-3 h-3 ms-1.5" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                viewBox="0 0 24 24">
                                                <path
                                                    d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <div class="flex items-center">
                                        Umur
                                        <a href="{{ route('admin.karyawan', ['sort_field' => 'umur', 'sort_direction' => ($sortField === 'umur' && $sortDirection === 'asc') ? 'desc' : 'asc']) }}"><svg class="w-3 h-3 ms-1.5" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            viewBox="0 0 24 24">
                                            <path
                                                d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <div class="flex items-center">
                                        Jabatan
                                        <a href="{{ route('admin.karyawan', ['sort_field' => 'jabatan', 'sort_direction' => ($sortField === 'jabatan' && $sortDirection === 'asc') ? 'desc' : 'asc']) }}"><svg class="w-3 h-3 ms-1.5" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            viewBox="0 0 24 24">
                                            <path
                                                d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <div class="flex items-center">
                                        Alamat
                                        <a href="{{ route('admin.karyawan', ['sort_field' => 'alamat', 'sort_direction' => ($sortField === 'alamat' && $sortDirection === 'asc') ? 'desc' : 'asc']) }}"><svg class="w-3 h-3 ms-1.5" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            viewBox="0 0 24 24">
                                            <path
                                                d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                                ...
                                @foreach ($karyawans as $karyawan)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <button type="button" data-modal-target="update-modal"
                                                data-modal-toggle="update-modal"
                                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</button>
                                            <button type="button" data-modal-target="delete-modal"
                                                data-modal-toggle="delete-modal"
                                                class="ml-8 font-medium text-red-600 dark:text-red-500 hover:underline">Hapus</button>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="bg-white rounded-lg shadow-lg w-full max-w-md">
                                            ...
                                            <div class="flex justify-between items-center p-5 border-b">
                                                ...
                                                <button type="button" class="close text-gray-400 hover:text-gray-500"
                                                    data-modal-hide="update-modal">&times;</button>
                                            </div>
                                            <!-- Modal body -->
                                            <div class="p-5">
                                                <!-- Alert Sukses -->
                                                ...
                                                <form action="{{ route('karyawan.update', ['id' => $karyawan->id]) }}"
                                                    ...
                                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                                        <div class="col-span-2">
                                                            <label for="name"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
                                                            <input value="{{ old('nama', $karyawan->nama) }}"
                                                        ...
                                                        <div class="col-span-2 sm:col-span-1">
                                                            <label for="price"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Umur</label>
                                                            <input value="{{ old('umur', $karyawan->umur) }}"
                                                                type="number" name="umur" id="umur"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                placeholder="18" required="">
                                                            @if ($errors->has('umur'))
                                                                <small class="text-red-700 ml-1">
                                                        ...
                                                        <div class="col-span-2 sm:col-span-1">
                                                            ...
                                                            <select id="jabatan" name="jabatan"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                                                <option selected="">
                                                                    {{ old('jabatan', $karyawan->jabatan) }}</option>
                                                                <option value="Senior Web Developer">Senior Web
                                                                    Developer</option>
                                                                <option value="Product Manager">Product Manager
                                                                </option>
                                                                <option value="QA Assurance">QA Assurance</option>
                                                                <option value="Junior Web Developer">Junior Web
                                                                    Developer</option>
                                                            </select>
                                                            @if ($errors->has('jabatan'))
                                                                <small class="text-red-700 ml-1">
                                                        ...
                                                        <div class="col-span-2">
                                                            ...
                                                            <textarea id="alamat" name="alamat" rows="4"
                                                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                                placeholder="Tulis alamat dari karyawan tersebut">{{ old('alamat', $karyawan->alamat) }}</textarea>
                                                            @if ($errors->has('alamat'))
                                                                <small class="text-red-700 ml-1">
                                                                    {{ $errors->first('alamat') }}
                                                                </small>
                                                    ...
                                                    <button type="submit"
                                                        class="w-full inline-flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Update</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5 text-center">
                                                    ...
                                                    <h3
                                                        ...
                                                        Apakah kamu yakin ingin menghapus data karyawan ini?</h3>

                                                    <form
                                                        action="{{ route('karyawan.destroy', ['id' => $karyawan->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
