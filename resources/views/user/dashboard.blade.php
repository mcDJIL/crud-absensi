...
<body>
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <a href="{{ route('user.dashboard') }}" class="flex items-center ps-2.5 mb-5">
    ...
    <script src="{{ mix('resource/js/client.js') }}"></script>
    <script>
        let data;

        document.addEventListener('DOMContentLoaded', () => {
            fetchDataTotalAbsent();
            fetchDataAbsentOnward();
            fetchDataBestEmployee();
        });

        function fetchDataTotalAbsent() {
        ...
        function fetchDataAbsentOnward() {
