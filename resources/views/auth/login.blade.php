...
<div class="mx-auto max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
        ...
        <div>
          <span class="font-medium">Kesalahan</span> {{ $errors->first('invalid') }}
        </div>
      </div>
    ...
    <form class="max-w-sm mx-auto" method="POST" action="{{ route('login') }}">
        ...
        <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Masuk</button>
</form>
<a href="{{ route('register') }}" class="flex justify-center"><small class="underline text-blue-700">Daftar akun</small></a>
